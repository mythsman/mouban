...
type Schedule struct {
	...
	Status    *uint8 `gorm:"not null;index:idx_status,priority:2;index:idx_search,priority:2;index:idx_schedule_status"`
	Result    *uint8 `gorm:"not null;index:idx_result,priority:2;index:idx_search,priority:2"`
	CreatedAt time.Time
	UpdatedAt time.Time `gorm:"index:idx_result,priority:3;index:idx_status,priority:3;index:idx_search,priority:3"`
}
